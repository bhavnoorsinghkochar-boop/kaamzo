cat << 'INNER_EOF' > otp_replacement.txt
...
INNER_EOF
sed -i -e '/{job.escrowStatus === '\''pending'\'' ?/,/ : (job.status === '\''accepted'\''/c\' -e "$(cat otp_replacement.txt)" src/components/customer/CustomerApp.tsx
